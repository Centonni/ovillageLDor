...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ovillageLDor@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ovillageLDor API";

        private String description = "ovillageLDor API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ovillageLDor";
