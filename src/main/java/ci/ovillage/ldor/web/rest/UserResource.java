...
import ci.ovillage.ldor.domain.Authority;
import ci.ovillage.ldor.domain.User;
import ci.ovillage.ldor.repository.AuthorityRepository;
import ci.ovillage.ldor.repository.UserRepository;
import ci.ovillage.ldor.repository.search.UserSearchRepository;
import ci.ovillage.ldor.security.AuthoritiesConstants;
import ci.ovillage.ldor.service.UserService;
import ci.ovillage.ldor.web.rest.dto.ManagedUserDTO;
import ci.ovillage.ldor.web.rest.dto.UserDTO;
import ci.ovillage.ldor.web.rest.util.HeaderUtil;
import ci.ovillage.ldor.web.rest.util.PaginationUtil;
