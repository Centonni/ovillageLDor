package ci.ovillage.ldor.config;

import ci.ovillage.ldor.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("ci.ovillage.ldor.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("ci.ovillage.ldor.repository.search")
